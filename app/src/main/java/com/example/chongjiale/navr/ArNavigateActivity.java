...
public class ArNavigateActivity extends AppCompatActivity {
    ...
    private IALocationListener mLocationListener = new IALocationListenerSupport() {
        ...
        public void onLocationChanged(IALocation location) {
            ...
            Toast.makeText(ArNavigateActivity.this, latlong, Toast.LENGTH_SHORT).show();
    ...
    private IARegion.Listener mRegionListener = new IARegion.Listener() {
        ...
        public void onEnterRegion(IARegion region) {
            if (region.getType() == IARegion.TYPE_FLOOR_PLAN) {
                ...
                Toast.makeText(ArNavigateActivity.this, id, Toast.LENGTH_SHORT).show();
                fetchFloorPlan(id);
            }
        }
    ...
    public static final String TAG = "ArDisplayView Log";
                ...
                public void onResult(IAResult<IAFloorPlan> result) {
                    ...
                    if (result.isSuccess() && result.getResult() != null) {
                        ...
                        if (!asyncResult.isCancelled()) {
                            Toast.makeText(ArNavigateActivity.this,
