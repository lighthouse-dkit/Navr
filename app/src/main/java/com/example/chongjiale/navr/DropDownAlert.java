...
import com.example.chongjiale.navr.R;
...
public final class DropDownAlert {
    ...
    public DropDownAlert(Activity activity) {
        ...
        mAlertView = factory.inflate(R.layout.drop_down, null);
        mAlertImagesLayout = mAlertView.findViewById(R.id.dropdown_alert_img);
        mAlertText = mAlertView.findViewById(R.id.dropdown_alert_tx);
    }
